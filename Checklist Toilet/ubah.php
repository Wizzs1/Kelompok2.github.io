...
<body class="bg-body-tertiary">
    <div class="container" style="background-color: #82CAFF; width: 50%; padding: 30px;">
        ...
        <div class="main">
            <form method="post" action="ubah.php" enctype="multipart/form-data">
                ...
                <input class= "btn" style="background-color: #1E90FF; color: #FFFFFF;" type="submit" name="submit" value="Simpan">
                </div>
            </form>
        </div>
    </div>
