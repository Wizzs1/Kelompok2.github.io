...
<div class="container" style=" background-color: #82CAFF; width: 70%; padding: 20px;" >
...
<h2 style="color: #000000; text-align: center;">LOGIN</h2><br>
    <form method="POST">
        <div class="mb-3 row" style="background-color: #1E90FF;">
        ...
        <br>
        <div class="submit">
            <button type="submit" name="submit" class="btn" style="background-color: #1E90FF; color: #FFFFFF n ;">Login</button>
        </div>
        <div><br><br>
            <p style="color: #000000;">Belum memiliki akun??</p>
            <a href="tam_login.php" style="color: #000000;">Buat Akun Baru</a>
        </div>
    </form>
</div>
</body>
